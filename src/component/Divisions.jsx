...
const Divisions = () => {
  ...
  return (
    <div
      ...
      id="divisions"
    >
      <h1 className="ylwColor font-bold mb-4 font-notoSerif px-4 text-2xl md:text-4xl mb-[250px] lg:mb-[320px]">
        Divisions
      </h1>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center ylwColor font-notoSerif font-extrabold">
        ...
        <div className="border rounded-md px-20 pt-15 pb-10 relative mb-[200px] md:mb-[0px]">
          <img
        ...
        <div className="border rounded-md px-20 pt-15 pb-10 relative mb-[0px]">
          <img
            src={`${
              import.meta.env.BASE_URL
