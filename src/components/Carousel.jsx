    ...
    <>
      ...
      >
        <div className="max-w-4xl mx-auto flex flex-col items-center justify-center h-full w-full py-20 sm:py-40 md:py-70 px-8 md:px-4">
          ...
          <p
            className="text-center text-white text-sm md:text-2xl mb-6"
            style={{ textShadow: "2px 2px 4px rgba(0,0,0,0.8)" }}
          >
          ...
          <button
            ...
            className="text-[10px] text-white hover:text-[#ed9127] px-4 md:px-6 py-1 md:py-2 rounded-full bg-[#ed9127] hover:bg-white  cursor-pointer relative z-10 transition-colors"
          >
            Contact Us
          </button>
        </div>
