          ...
          <div className="max-w-7xl mx-auto px-4 py-10">
            ...
            <ul className="list-disc list-outside leading-tight space-y-2 ps-5 mb-6 text-white text-md">
              ...
              <li>
                ...
                Arabia&#39;s spiritual soul - enhancing national image and
            ...
            <ul className="list-disc list-outside leading-tight space-y-2 ps-5 text-white text-md mb-[250px]">
              <li>
                ...
                centuries. Cultural Continuity: By restoring the Arab
                world&#39;s tangible and intangible heritage, we guard not just
                buildings but the soul of a civilization.
              </li>
              <li>
